...
<html>
	...
	<body>
		...
		<form method="post" action="rechercheAnnonceCat">	
		    <fieldset>
		        <legend>Rerchercher une annonce</legend>
		        
		        <label for="nomCat">Nom Catégorie</label>
		        <input type="text" id=nomCat name="nomCat" size="30" maxlength="60" /><br>
       ...
       <c:choose>
            ...
            <c:when test="${ resultat == 'CAT_NOT_FOUND'}">
                <p class="erreur">La catégorie spécifiée n'existe pas.</p>
            </c:when>
